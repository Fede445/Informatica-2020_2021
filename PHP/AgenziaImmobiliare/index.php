            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-right">
                  <a href="register.php" class="aa-register">Registrati</a>
                  <a href="signin.phph" class="aa-login">Accedi</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <nav class="navbar navbar-default main-navbar" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->
          <!-- Text based logo -->
          <a class="navbar-brand aa-logo" href="index.php"> Home <span>Proprietà</span></a>
          <!-- Image based logo -->
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
            ...
            <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="properties.html">PROPRIETÀ <span
                  class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="properties.html">Proprietà</a></li>
                <li><a href="properties-detail.html">Dettagli proprietà</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="blog-single.html">Dettagli Blog</a></li>
              </ul>
            </li>
      ...
      <div class="aa-top-slider">
        ...
        <div class="aa-top-slider-single">
          ...
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Villa a Gavorrano</span>
            <h4 class="aa-top-slider-title">450 mq</h4>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>Castellaccia, Grosseto (TOS)</p>
            <p class="aa-top-slider-price">€2.300.000</p>
            <a href="#" class="aa-top-slider-btn">Informazioni <span class="fa fa-angle-double-right"></span></a>
          </div>
          <!-- / Top slider content -->
        </div>
        <!-- / Top slider single slide -->
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Villa a Merate</span>
            <h4 class="aa-top-slider-title">800 mq</h4>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>Merate, Como (LOM)</p>
            <p class="aa-top-slider-price">Prezzo su richiesta</p>
            <a href="#" class="aa-top-slider-btn">Informazioni <span class="fa fa-angle-double-right"></span></a>
          </div>
          <!-- / Top slider content -->
        </div>
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Villa Antinori di Monte Aguglioni</span>
            <h4 class="aa-top-slider-title">4000 mq</h4>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>Scandicci, Firenze (TOS)</p>
            <p class="aa-top-slider-price">€30.000.000</p>
            <a href="#" class="aa-top-slider-btn">Informazioni <span class="fa fa-angle-double-right"></span></a>
          </div>
          <!-- / Top slider content -->
        </div>
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Villa di inizio '900</span>
            <h4 class="aa-top-slider-title">700 mq</h4>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>Firenze, Firenze, (TOS)</p>
            <p class="aa-top-slider-price">€7.450.000</p>
            <a href="#" class="aa-top-slider-btn">Informazioni <span class="fa fa-angle-double-right"></span></a>
          </div>
          <!-- / Top slider content -->
        </div>
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Castello in Chianti</span>
            <h4 class="aa-top-slider-title">5000 mq + 100 ettari</h4>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>Chianti, Firenze (TOS)</p>
            <p class="aa-top-slider-price">TRATTATIVA RISERVATA</p>
            <a href="#" class="aa-top-slider-btn">Informazioni <span class="fa fa-angle-double-right"></span></a>
          </div>
          <!-- / Top slider content -->
        </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="aa-single-advance-search">
                  <input type="text" placeholder="Città/CAP">
                </div>
              </div>
              <div class="col-md-2">
                <div class="aa-single-advance-search">
